...
def run(model, audio, hot_words, scorer):
    ...
    for word in hot_words.split(' '):
        ds.clearHotWords()
        ds.addHotWord(word, 10.0)
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        run('SpeechModel/deepspeech-0.9.3-models.pbmm', "SpeechModel/wave.wav")
